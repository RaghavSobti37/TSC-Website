    ...
    <section id="projects" className="py-20 px-6 bg-gray-50 dark:bg-black">
      <div className="container mx-auto">
        <div className="text-center mb-12">
          <h2 className="heading-font text-4xl font-bold text-gray-800 dark:text-gray-200">Featured Projects</h2>
          <p className="text-lead text-gray-600 dark:text-gray-400 mt-2">A selection of our favorite work.</p>
        </div>
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          {projects.map((project) => {
            ...
            return (
              <div key={project.id} className={`bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden group ${project.colSpan}`}>
                ...
                <div className="p-6 flex flex-col">
                  <p className="text-sm font-semibold text-indigo-600 dark:text-indigo-400">{project.category}</p>
                  <h3 className="text-xl font-bold mt-1 text-gray-900 dark:text-white">{project.title}</h3>
                  ...
                  {showToggleButton && (
                    <button onClick={() => handleToggleDescription(project.id)} className="text-indigo-600 hover:text-indigo-800 dark:text-indigo-400 dark:hover:text-indigo-300 text-sm font-semibold mt-4 self-start">
