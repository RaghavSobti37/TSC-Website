...
- [Book A Call](./book-a-call/) — `/book-a-call` → `pages/book-a-call.html`
- [Book An Artist](./book-an-artist/) — `/book-an-artist` → `pages/book-an-artist.html`
- [Artist Path Query](./artist-query/) — `/artist-query` → `pages/artist-query.html`
- [Collab Q](./collab-query/) — `/collab-query` → `pages/collab-query.html`
