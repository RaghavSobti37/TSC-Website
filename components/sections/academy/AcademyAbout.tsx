      ...
      <Container>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-12">
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-teal-dark font-signika leading-tight tracking-tight">
            ...
            <motion.div
              ...
              className={`
                ...
                ${card.highlight 
                  ...
                  : 'bg-white border-slate-lightest hover:border-teal-primary/30 shadow-sm hover:shadow-xl'}
                ${card.fullWidth ? 'md:col-span-2 lg:col-span-3 bg-gradient-to-r from-teal-dark/5 to-pumpkin/5' : ''}
              `}
            >
              {/* Hover line accent */}
              <div className={`absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-teal-primary to-pumpkin transform origin-left transition-transform duration-500 ${card.highlight ? 'scale-x-100' : 'scale-x-0 group-hover:scale-x-100'}`} />
              
              <div className="text-5xl mb-6 filter drop-shadow-md">{card.icon}</div>
              <h3 className="text-xl font-bold text-teal-dark mb-4 font-signika">{card.title}</h3>
