...
export default function AcademyCTA() {
  return (
    <Section id="cta" background="teal" padding="xl" className="relative overflow-hidden">
      {/* Decorative background elements */}
      <div className="absolute top-0 right-0 w-96 h-96 bg-pumpkin/10 rounded-full blur-[100px] -mr-48 -mt-48" />
      <div className="absolute bottom-0 left-0 w-96 h-96 bg-teal-light/20 rounded-full blur-[100px] -ml-48 -mb-48" />
