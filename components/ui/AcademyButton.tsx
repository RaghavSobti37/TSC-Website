...
export const AcademyButton: React.FC<AcademyButtonProps> = ({
  ...
  const variants = {
    gradient: "bg-gradient-to-r from-mustard to-wine text-white hover:opacity-90 shadow-lg",
    outline: "border border-white/30 bg-white/5 text-white hover:bg-white/10",
    dark: "border border-charcoal/30 bg-charcoal/5 text-charcoal hover:bg-charcoal/10"
  };
